...
async def extract_rowing_data(image_data: bytes, model_name: str = "chatgpt-4o") -> Dict[str, Any]:
    """
    ...
    try:
        ...
        llm_response = model.prompt(prompt, attachments=[llm.Attachment(content=image_data)],json_object=True)
